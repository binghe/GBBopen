...
%% *-* Last-Edit: Wed Feb 18 01:30:42 2009; Edited-By: cork *-*
...
\nobr{\textbf{\entlink{awaken-thread}}}.  Note that when a thread is
hibernating, it remains available to respond to
...
\nobr{\textbf{\entlink{atomic-pop}}}.  It is intended only for implementing
very brief atomic operations and should not be used for long computations or
