...
%% *-* File: /home/gbbopen/current/doc-source/portable-threads-entities.tex *-*
%% *-* Last-Edit: Sat Feb 23 16:40:06 2008; Edited-By: cork *-*
...
implementations without thread support.  The \glref{feature}
\code{:with-timeout-not-available} is added on Common Lisp implementations
that do not support \textbf{\entlink{with-timeout}}.
...
\code{:threads-not-available} is returned.
