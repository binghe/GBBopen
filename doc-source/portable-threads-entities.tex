...
%% *-* Last-Edit: Wed Nov 12 04:58:46 2008; Edited-By: cork *-*
...
precise instant the \textbf{all-threads} function is called.  New threads may
be created or existing threads killed at any time, so the returned list is
always potentially outdated.
