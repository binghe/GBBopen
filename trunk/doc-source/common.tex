...
%% *-* Last-Edit: Tue Apr 15 04:50:18 2008; Edited-By: cork *-*
...
\newcommand{\emptytable}{\xml{table class="tighttop" width="100%"}\xml{/table}}
...
\newcommand{\fndsyntax}{\emptytable{}
  \xml{span class="fndoclabel"}Detailed syntax\xml{/span}\\}  
\newcommand{\fndsyntaxwgray}{\emptytable{}
  \xml{span class="fndoclabel"}Detailed syntax\xml{/span}\\
