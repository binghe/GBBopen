...
%% *-* Last-Edit: Wed Apr  2 04:30:13 2008; Edited-By: cork *-*
...
\newcommand{\gbbopenversion}{0.9.9}
...
\definecolor{darkergray}{gray}{.40}
...
\T\begin{ifhtml}
  ...
  \newcommand{\fnalternate}[2]{\xml{table class="tight" width="100%"}
      \xml{tr valign="top"}
      \xml{td align="left"}
        \xml{nobr}#1\xml{/nobr}
        \xml{/td}
  ...
  \newcommand{\fnsetfsyntax}[3]{\xml{table class="tight" width="100%"}
      \xml{tr valign="top"}
      \xml{td align="left"}
...
\newcommand{\fndsyntaxwgray}{\par\endpar
  \xml{span class="fndoclabel"}Detailed syntax\xml{/span}\\
